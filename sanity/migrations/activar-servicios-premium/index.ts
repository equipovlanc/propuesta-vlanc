 ...
 *
 *   1) Copia esta carpeta entera a:  <studio>/migrations/activar-servicios-premium/
 ...
 *
 * El simulacro es el comportamiento por defecto: sin `--no-dry-run` solo te imprime
 * las mutaciones que haría. Al aplicar, el CLI te pide confirmación del dataset.
 */
