...
const Mission: React.FC<MissionProps> = ({ data, step = 0, isPrint = false }) => {
    ...
    return (
        <section className="h-full w-full flex flex-col lg:flex-row overflow-hidden relative">
            ...
            <div className="w-full lg:w-[55.7%] h-full flex items-center justify-center relative z-10">
                ...
                <motion.div 
                    ...
                    initial={isPrint ? false : { 
                        x: step === 0 ? '22.15vw' : 0 
                    }}
                    animate={isPrint ? false : { 
                        x: step === 0 ? '22.15vw' : 0 
                    }}
                    transition={{ 
                        duration: 1.2, 
                    ...
                    style={isPrint ? { transform: 'none', x: 0 } : {}}
                >
