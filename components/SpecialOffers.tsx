      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
        <div className="space-y-12">
            ...
            <AnimatedSection>
                 <div className="border-l-4 border-teal-400 pl-6">
                    ...
                    <div className="p-6 bg-teal-50 text-center">
        ...
        <AnimatedSection>
            <div className="relative">
                {data?.callToAction?.image && <img src={data.callToAction.image} alt="Modern bedroom interior" className="rounded-lg shadow-2xl" />}
