            ...
            <div className="max-w-7xl mx-auto flex flex-col items-center text-center">
                ...
                <AnimatedSection className="mt-24 no-print">
                    ...
                    >
                        ...
                        IMPRIMIR WEB (MODO PERGAMINO)
                    </button>
                    <div className="mt-6 text-sm text-gray-500 max-w-lg mx-auto bg-gray-50 p-4 rounded-lg border border-gray-200 text-left">
                        <p className="font-bold mb-2">Configuración recomendada:</p>
                        <ul className="list-disc list-inside space-y-1">
                            <li>Destino: <strong>Guardar como PDF</strong></li>
                            <li>Diseño: <strong>Horizontal</strong></li>
                            <li>Márgenes: <strong>Ninguno</strong></li>
                            <li>Gráficos de fondo: <strong>Activado</strong></li>
                            <li>Escala: <strong>Ajustar al área de impresión</strong> (o probar aprox 60-70% si sale cortado).</li>
                        </ul>
                    </div>
                </AnimatedSection>
            </div>
