                        ...
                        {videoSrc && (
                            ...
                            >
                                <div className="relative w-full h-full" onClick={() => handlePlayPause()}>
                                    ...
                                    <div 
                                        className="absolute bottom-0 left-0 right-0 p-3 bg-gradient-to-t from-black/80 to-transparent flex items-center gap-3" 
                                        onClick={e => e.stopPropagation()}
                                    >
                                        <button onClick={handlePlayPause} className="text-white p-2 focus:outline-none">
                                        ...
                                        <div className="flex items-center gap-2">
                                            <button onClick={handleMuteToggle} className="text-white p-2 focus:outline-none">
                                        ...
                                        <button onClick={handleFullscreen} className="text-white p-2 focus:outline-none">
