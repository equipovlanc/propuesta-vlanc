            ...
            <section className="h-full w-full flex flex-col items-center pt-[150px] px-[120px] relative">
                <div className="w-full max-w-[1320px] flex flex-col">
                    <div className="w-full aspect-[1320/670] shrink-0 relative">
                        ...
                        <motion.div className="w-full h-full print-force-visible" initial={{ opacity: 0 }} animate={{ opacity: (isSectionCompleted || step >= 2) ? 1 : 0 }} transition={{ duration: 1.5, ease: "easeInOut" }}>
                            {imageSrc && (
                    ...
                    <motion.div className="mt-12 text-right print-force-visible" initial={{ opacity: 0, y: 20 }} animate={{ opacity: (isSectionCompleted || step >= 3) ? 1 : 0, y: (isSectionCompleted || step >= 3) ? 0 : 20 }} transition={{ duration: 1.5, ease: "easeOut", delay: (isSectionCompleted || step >= 3) ? 0.5 : 0 }}>
