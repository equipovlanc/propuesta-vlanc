  ...
  return (
    <section className="h-full w-full bg-vlanc-bg flex flex-col justify-center px-12 md:px-24 py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start h-full overflow-hidden">
            {/* Columna Izquierda: Texto Estructurado (60%) */}
            <div className="lg:col-span-7 h-full overflow-y-auto no-scrollbar pr-4">
                <AnimatedSection>
                    <h3 className="text-[24px] font-serif italic text-vlanc-black mb-8 font-normal">{data?.intervention?.title}</h3>
                    
                    <div className="space-y-6 text-vlanc-secondary text-[12px] font-sans">
                        ...
                        <div className="pt-4 border-t border-vlanc-primary/10">
                             ...
                             <div 
                                className="mt-2 leading-relaxed whitespace-pre-line text-justify"
                                dangerouslySetInnerHTML={{ __html: data?.intervention?.program || '' }}
                             />
                        </div>
                    </div>
                    
                    <div className="mt-8 space-y-4 text-vlanc-secondary text-[12px]">
            ...
            {/* Columna Derecha: Video o Imagen (40%) */}
