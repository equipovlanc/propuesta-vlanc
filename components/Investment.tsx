        ...
        <section className="h-full w-full flex flex-col justify-start pt-[150px] pb-[140px] px-[120px] relative">
            ...
            <div className="w-full flex flex-row gap-[120px] items-start flex-1 min-h-0 relative">
                ...
                <div className="shrink-0 flex flex-col relative w-[820px] h-full">
                    <div 
                        className="absolute right-0 w-full grid grid-rows-[1fr_auto]"
                        style={{ bottom: '40px', minHeight: 'calc(100% - 40px)' }}
                    >
                        <AnimatedSection
                            className="w-full h-full flex flex-col relative rounded-sm overflow-hidden"
                            hierarchy={2}
                        >
