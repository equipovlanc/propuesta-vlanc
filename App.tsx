    ...
    return (
      <div id="app-container" className="print-container">
        {sections.map((section, index) => {
          ...
          return (
            <div key={`print-slide-${index}`} style={{ width: '420mm', height: '297mm', position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden', pageBreakAfter: 'always', breakAfter: 'page', backgroundColor: '#ffffff' }}>
              <div style={{ width: '1920px', height: '1080px', position: 'relative', transformOrigin: 'center', transform: 'scale(0.8267)', backgroundColor: '#efe8e1', overflow: 'hidden' }}>
                {compWithMaxStep}
              </div>
            </div>
          );
