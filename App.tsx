...
export const App: React.FC = () => {
  ...
  return (
    <ScrollContext.Provider value={direction}>
        ...
        {/* PRINT CONTAINER - Hidden on screen, visible in print */}
        <div id="print-container" className="hidden">
            {sections.map((section, index) => (
                <div key={index} className="print-slide">
                    <div className="print-slide-content relative overflow-hidden">
                        {/* Header for Print (skip for Hero/Index if needed, based on logic) */}
                        {section.headerPage && (
                        ...
                        {/* Clone element to pass print props */}
                        {React.cloneElement(section.comp as React.ReactElement<any>, { 
                            step: 99, // Force full reveal
                            isPrint: true // Custom prop for print logic
                        })}
                    </div>
                </div>
            ))}
