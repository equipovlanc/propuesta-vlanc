...
const App: React.FC = () => {
  ...
  useEffect(() => {
    if (proposalData?.payment?.finePrint) {
      // El contenedor real visualmente tiene ~488px de altura (-50px de margen inferior). 
      // Calculamos con 470 para dar un pequeño margen de seguridad y evitar cortes.
